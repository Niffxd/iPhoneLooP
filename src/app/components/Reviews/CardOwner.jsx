...
export default function CardOwner() {
  ...
  const author = {
    ...
    photoUri: "https://lh5.googleusercontent.com/p/AF1QipMtosBg8Hvrdh-BqlcmA-7rgo6veT_GNSNOsyWo=w90-h90-p-k-no-rp-br100",
    rating: 5,
    ...
    <Link href={author.uri} target='_blank'>
      <article className={style.card_owner_container}>
        <div className={style.owner_profile}>
          <Image src={author.photoUri} alt='profile-photo' width={48} height={48} loading='lazy' />
